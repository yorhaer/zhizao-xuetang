...
- 学员端：查看我的培训、课程资料、知识库、考核结果、个人资料，并对导师进行评价。
- 导师端：管理课件、记录学员平时评价、设置阶段考试、查看学员反馈、维护个人资料。
- 台账后台：维护培训台账、培训计划、执行记录、考核数据、人员信息、导师/学员档案、导入导出数据。
...
| 角色 | 入口 | 说明 |
| --- | --- | --- |
| 学员 | `/student/training` | 查看培训、课件、知识库、考核、评价和个人资料 |
| 导师 | `/tutor/courseware` | 管理课件、平时评价、阶段考试、学员反馈和个人资料 |
